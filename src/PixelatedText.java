...
public class PixelatedText {
	...
	public static void draw(String text, int x, int y, int size) {
		...
		for(int i=0;i<text.length();i++) {
			...
			drawChar(character,x+shift,y,size);
			if(character=='.' || character==',' || character=='!' || character=='(' || character==')')
				shift+=3*size;
			else if(character=='I' || character=='J' || character=='T' || character=='Y' || character=='1' || character=='+' || character=='-')
				shift+=4*size;
	...
	public static void drawChar(char character, int x, int y, int size) {
		...
		if(character>='A' && character<='Z')
			...
			index=45;
		drawArray(toBooleanArray(index),x,y,size);
	}
	...
	public static void drawArray(boolean[][] array, int x, int y, int size) {
		Zen.setColor(0,0,0);
